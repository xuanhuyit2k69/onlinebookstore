...
import vn.edu.xyz.olms.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/loans").hasAnyRole("READER", "LIBRARIAN")
                .requestMatchers(HttpMethod.PATCH, "/api/loans/*/confirm").hasRole("LIBRARIAN")
